...
Get Safebucket running locally with minimal dependencies using Docker Compose. This lightweight deployment uses only 2
containers and is ideal for quick testing, demos or homelabs.
...
- [Local Full Deployment](local-full-deployment) for a production-like setup with all services
