...
Get Safebucket running locally with the full infrastructure stack using Docker
Compose. This deployment includes all services (caching, event streaming, email
testing, and activity logging) for a production-like environment.
